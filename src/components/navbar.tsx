  ...
  return (
    <nav className="m-2 bg-gradient-to-r from-gray-900 to-[#0A3D2E] py-4 px-6 flex items-center justify-between rounded-lg">
      ...
      <div className="text-white font-medium">
        <Link href="/marketplace" className="hover:text-gray-300 transition">Marketplace</Link>
      </div>

      {/* Wallet Connection Button */}
      <Button onClick={connect} className="bg-[#8de0c8] hover:bg-[#7bc9b3] text-black font-bold rounded-md">
